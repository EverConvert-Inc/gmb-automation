...
// Ads Conversion Tracker x CallRail report config: which CallRail tags
// this client actually uses and whether each counts toward "real" or
// "junk" call volume. Team can add/edit/remove/reorder freely — this
// isn't a fixed list baked into code.
export function PpcCallrailTagCategoriesCard({
  clientId,
  initial,
}: {
  clientId: string;
  ...
  const base = `/api/ppc/clients/${clientId}/tag-categories`;
